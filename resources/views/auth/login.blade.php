    ...
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-md">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="email" name="email" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" required autofocus>
            ...
            <button type="submit" class="w-full bg-teal-500 text-white font-bold py-3 rounded-lg hover:bg-teal-600 transition">Se connecter</button>
        </form>
        <p class="text-center mt-6 text-sm text-slate-600">
            Pas encore de compte ? <a href="{{ route('register') }}" class="text-teal-600 font-bold hover:underline">S'inscrire</a>
        </p>
    </div>
</div>
@endsection
